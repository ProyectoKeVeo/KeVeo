...
@Service
public class GestionUserService extends AbstractBusinessService<UserEntity,Integer,UserDTO, UserRepository, MapperUser> {

    @Autowired
    protected GestionUserService(UserRepository repository, MapperUser serviceMapper) {
